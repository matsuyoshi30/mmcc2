...
assert 4 'int main() { int x[2]; x[0]=3; x[1]=4; return x[1]; }'
assert 5 'int main() { int x[3]; x[0]=3; x[2]=5; return x[2]; }'
assert 3 'int main() { int a[2]; a[0]=1; a[1]=2; int *p; p=&a; return a[0]+*(p+1); }'
